...
module.exports = class Repository extends ErrorStash {
  constructor (nop, github, repo, settings, deploymentSettings, log, errors) {
    super(errors)
    this.github = github
  ...
  async sync () {
    ...
    const mergeDeep = new MergeDeep(this.log, this.github, ignorableFields, this.deploymentSettings)
    ...
    return this.github.repos.get(this.repo)
      .then(resp => {
        ...
        this.log.debug(`Result of comparing repo for changes = ${JSON.stringify(results, null, 2)}`)
