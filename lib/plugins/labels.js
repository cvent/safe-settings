...
module.exports = class Labels extends Diffable {
  constructor (nop, github, repo, entries, deploymentConfig, log, errors) {
    ...
    if (Array.isArray(include)) {
      ...
      //   include:
      //     - name: label
      super(nop, github, repo, include, deploymentConfig, log, errors)
    } else {
      // Config is array
      // labels:
      //   - name: label
      super(nop, github, repo, entries, deploymentConfig, log, errors)
    }
