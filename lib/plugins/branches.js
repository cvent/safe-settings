...
module.exports = class Branches extends ErrorStash {
  constructor (nop, github, repo, settings, deploymentConfig, log, errors) {
    super(errors)
    this.github = github
    this.repo = repo
          ...
          .map(branch => {
            ...
            if (this.isEmpty(branch.protection)) {
              ...
              return this.github.repos.getBranchProtection(params).then((result) => {
                const mergeDeep = new MergeDeep(this.log, this.github, ignorableFields, this.deploymentConfig)
